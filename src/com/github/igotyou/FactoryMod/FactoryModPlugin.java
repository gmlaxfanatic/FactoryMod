...
public class FactoryModPlugin extends JavaPlugin
{
	...
	public static List<ProbabilisticEnchantment> getEnchantments(ConfigurationSection configEnchantments)
	{
	...
	public static ItemList<NamedItemStack> getItems(ConfigurationSection configItems)
	{
	...
	private static NamedItemStack createItemStack(Material material,int stackSize,short durability,String name,String loreString,String commonName)
	{
